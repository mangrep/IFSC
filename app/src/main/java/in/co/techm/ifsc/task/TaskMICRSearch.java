 ...
 */
public class TaskMICRSearch extends AsyncTask<String, Void, BankDetailsRes> {
    ...
    public TaskMICRSearch(BankDetailsLoadedListener bankDetailsLoadedListener, Context context) {
